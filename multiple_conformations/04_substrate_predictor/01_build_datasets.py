...
def main():
    ...
    datafile = os.path.join("..", "03_build_dbs", "nitrilase.json")
    with open(datafile) as in_stream:
        database = json.load(in_stream)
    data_clu_path = os.path.join("..", "03_build_dbs", "clusters.json")
    ...
    for clu in range(clusters):
        ...
        data_from = os.path.join("..", "03_build_dbs", "cluster_{}".format(clu))
