...
def add_accessibility_to_file(input_files, output_files):
    ...
    for input_file, output_file in zip(input_files, output_files):
        ...
        add_hydrogens_to_ligand.add_hydrogens_batch(hydrogen_dir, MODE)
...
def _add_accessibility_to_set_of_fragments(database, fragments_set, candidate_names):
    ...
    for fragment in fragments_set:
        _add_accessibility_to_fragment(database, fragment, candidate_names)
...
def _add_accessibility_to_fragment(database, fragment, candidate_names):
    ...
    _replace_candidate_molecules(interactions, molecule_with_hydrogens)
...
def _replace_candidate_molecules(candidates, molecule_with_hydrogens):
    """
